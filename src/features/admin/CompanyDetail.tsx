    ...
    <div className="flex items-center gap-2 mb-6 flex-wrap">
      {([
        ...
        <Button
          ...
          size="sm"
          onClick={() => { setTab(key); setSelectedBarberId(null); }}
        >
    ...
    <div>
      ...
      {tab === 'barbers' && !selectedBarberId && (
        <Card className="bg-white border border-[#d4d2e3]">
          ...
          {barbersError && <p className="text-red-700 mb-4">{barbersError}</p>}
          {barbersLoading ? (
      ...
      {tab === 'barbers' && selectedBarberId && (
        <div>
          <Button variant="ghost" size="sm" className="mb-4" onClick={() => { setSelectedBarberId(null); setBarberDetail(null); }}>
            <ArrowLeft className="w-4 h-4" /> Back to Roster
          </Button>
          {barberDetailError && <p className="text-red-700 mb-4">{barberDetailError}</p>}
          {barberDetailLoading ? (
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-white border border-[#d4d2e3]">
                ...
                {barberDetail.services.length === 0 ? (
                  <p className="text-[#a09cab]">No services listed.</p>
                ) : (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {barberDetail.services.map((s) => (
              ...
              <Card className="bg-white border border-[#d4d2e3]">
                ...
                {barberDetail.recent_bookings.length === 0 ? (
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {barberDetail.recent_bookings.map((b: any) => (
              ...
              <Card className="bg-white border border-[#d4d2e3]">
                ...
                {barberDetail.reviews.length === 0 ? (
                  <p className="text-[#a09cab]">No reviews yet.</p>
                ) : (
                  <div className="space-y-3">
                    {barberDetail.reviews.map((r) => (
      ...
      {tab === 'payments' && (
        <div className="space-y-6">
          <Card className="bg-white border border-[#d4d2e3]">
            ...
            {paymentsError && <p className="text-red-700 mb-4">{paymentsError}</p>}
            {paymentsLoading ? (
